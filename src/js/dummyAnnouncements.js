...
var announcements = [
{
	...
	content: "The original plan was to discuss the last homework (HW12) during the last lecture slot (since there are no more tutorials next week).<br>	However, Prof. Tan has a different lacture planned for that date.<br>Hence I will post the solutions for HW12 after the dure date. Feel free to item me of you have any quesitons about them.<br>--LB",
...
},
{
...
},
    {
        ...
        title: "Typo in L13-summary.pdf",
        content: "For slide 16, please change \"no\" to \"yes\". Sorry for the mistake. --Ken",
        files: "",
        time: new Date("April 22, 2015 06:33:00"),
        read: false,
        favourited: 0,
        remindInstance: null,
        remindOn: null
    ...
    },
    {
        ...
        title: "HW3 and HW4 collection",
        content: "<div>Hi to all in CS3230,</div><div>&nbsp;</div><div>Your scores for HW3 and HW4 are now available on IVLE gradebook.<br>&nbsp;</div><div>You can collect your homework scripts at the table out side prof Leong&#39;s office.<br>&nbsp;</div><div>I have sorted them by groups. Please keep them in order when you collect yours.</div><div>&nbsp;</div><div>All the best for your exam this Saturday!</div><div>&nbsp;</div><div>Regards,</div><div>Nam-Ninh</div>",
        files: "",
        time: new Date("April 22, 2015 15:59:00"),
        read: false,
        favourited: 1,
        remindInstance: null,
        remindOn: null
    ...
    },
    {
        ...
        title: "New Files in Workbin - CS3230 : DESIGN AND ANALYSIS OF ALGORITHMS",
        content: "<u>New Files :</u><br><br>Folder Name   :Assignments<br><br>Filename:T5-Fall-2014-SS.pdf<br>Description: Solution sketch to T5 (Amortization). Sorry, I thought that this was uploaded ages ago. --hon-wai<br><br>Click on the filename to download the file.",
        files: "",
        time: new Date("April 21, 2015 14:12:00"),
        read: false,
        favourited: 1,
        remindInstance: null,
        remindOn: null
